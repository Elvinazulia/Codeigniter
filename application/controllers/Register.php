...
class Register extends CI_Controller {
 ...
 function validation()
 {
  ...
  $this->form_validation->set_rules('tanggal', 'Name', 'required|trim');
  $this->form_validation->set_rules('hobi', 'Name', 'required|trim');
  $this->form_validation->set_rules('ibu', 'Name', 'required|trim');
  $this->form_validation->set_rules('sekolah', 'Name', 'required|trim');
